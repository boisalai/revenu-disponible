...
Un **[guide pédagogique détaillé](docs/guide/main.pdf)** (PDF, 39 pages) décrit chaque poste : règle de calcul, paramètres 2025/2026, références légales.
...
A **[detailed educational guide](docs/guide/main.pdf)** (PDF, 39 pages, in French) covers every item: calculation rule, 2025/2026 parameters, legal references.
