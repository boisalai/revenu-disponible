...
- ⏳ **Activation prod** (action utilisateur) : créer une base **Neon**, ajouter sur Vercel `DATABASE_URL`, `BETTER_AUTH_SECRET`, `BETTER_AUTH_URL` (+ Google optionnel), puis `prisma migrate deploy` contre Neon.
