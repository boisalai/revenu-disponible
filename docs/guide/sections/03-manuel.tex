...
\begin{figure}[t]
  ...
  \D{50000} de revenu de travail, 40~ans), saisissable à la main ou chargée
  d'un clic parmi les ménages types du guide ; le revenu disponible 2025 et
  2026 avec sa ventilation poste par poste --- le volet central se poursuit,
  plus bas, par la carte des seuils (section~\ref{sec:seuils},
  figure~\ref{fig:carte-seuils}) et le graphique du TEMI
  (section~\ref{sec:temi}, figure~\ref{fig:graphique-temi}) ; et le volet
  droit --- ici l'assistant d'intelligence artificielle, avec son sélecteur
  de modèle, qui explique le résultat affiché.}
