...
\begin{description}
  ...
  ouvre le détail du poste dans le volet droit. Plus bas, le
  ...
  par catégorie (cotisations, impôts, transferts récupérés) ; les zones où le
  TEMI dépasse \pc{60} --- les \og trappes \fg{} --- y sont marquées en
  rouge, et un tableau donne la décomposition exacte au revenu actuel du
  ménage.
