...
\pnotes Deux éléments du programme réel restent hors modèle : le
\emph{supplément pour invalidité} (jusqu'à \D{851} en 2025 par bénéficiaire
admissible au crédit d'impôt pour personnes handicapées --- aucune entrée
d'invalidité dans le calculateur) et les \emph{versements anticipés
automatiques} (depuis juillet 2023, l'ARC verse d'office jusqu'à \pc{50} de
l'allocation estimée, en trois versements trimestriels --- sans effet sur
le montant annuel, seul le moment du versement change).

\input{exemples/16-act}
...
CFFP, \emph{Guide des mesures fiscales}, fiche \og Allocation canadienne
pour les travailleurs \fg{}\footnote{\url{https://cffp.recherche.usherbrooke.ca/outils-ressources/guide-mesures-fiscales/allocation-canadienne-travailleurs/}}.
