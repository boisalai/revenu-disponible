...
export const UI = {
  ...
  enAnnee: { fr: "en", en: "in" },
  posRecoit: { fr: "votre ménage reçoit", en: "your household receives" },
  posPaie: { fr: "votre ménage paie", en: "your household pays" },
  posDePlusTransferts: { fr: "de plus en transferts qu'il ne paie d'impôts", en: "more in transfers than it pays in taxes" },
  posDePlusImpots: { fr: "de plus en impôts qu'il ne reçoit en transferts", en: "more in taxes than it receives in transfers" },
  posTransferts: { fr: "de transferts", en: "in transfers" },
  posImpots: { fr: "d'impôts", en: "in taxes" },
  posContre: { fr: "contre", en: "versus" },
  posDe: { fr: "de", en: "by" },
  ...
  basculeContributeur: { fr: "Devient contributeur net (impôts > transferts)", en: "Becomes a net contributor (taxes > transfers)" },
  seuilRevenu: { fr: "À partir d'un revenu de…", en: "From an income of…" },
  parGouvCourt: { fr: "par gouvernement : envers le Québec seul à", en: "by government: to Québec alone at" },
  fedSeulA: { fr: "envers le fédéral seul à", en: "to the federal government alone at" },
  segBeneficiaire: { fr: "bénéficiaire net", en: "net beneficiary" },
  segContributeur: { fr: "contributeur net", en: "net contributor" },
